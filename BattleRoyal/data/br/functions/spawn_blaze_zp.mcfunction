execute in minecraft:the_nether as @e[type=zombified_piglin,tag=!n] at @s if predicate br:blaze_random run summon armor_stand ~ ~ ~ {Tags:["Blaze-zp"],Invisible:1b, Invulnerable:1b}
