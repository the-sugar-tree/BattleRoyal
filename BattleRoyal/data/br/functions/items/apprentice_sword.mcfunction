...
execute unless score @s ct.ap_sword > ap_sword ct.Max run give @s minecraft:iron_sword{display:{Name:'{"text":"Apprentice Sword","color":"green"}'},CustomModelData:1,Enchantments:[{id:"minecraft:sharpness",lvl:2s}]} 1
