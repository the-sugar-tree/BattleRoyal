...
execute unless score @s ct.dragon_sword > dragon_sword ct.Max run give @s minecraft:diamond_sword{display:{Name:'{"text":"Dragon Sword","color":"green","italic": false}',Lore:['{"text":"Special Ability","color":"gray","italic":false}','[{"text":"+1 ","color":"blue","italic":false},{"translate":"attribute.name.generic.attack_damage","color":"blue"}]']},CustomModelData:1,DragonSword:1b} 1
