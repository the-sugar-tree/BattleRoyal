...
execute unless score @s ct.tr_helmet > tr_helmet ct.Max run give @s minecraft:iron_helmet{display:{Name:'{"text":"Trained Helmet","color":"green"}'},Enchantments:[{id:"minecraft:protection",lvl:1s},{id:"minecraft:unbreaking", lvl: 1s}],CustomModelData:1} 1
