...
execute unless score @s ct.tr_sword > tr_sword ct.Max run give @s minecraft:iron_sword{display:{Name:'{"text":"Trained Sword","color":"green"}'},CustomModelData:1,Enchantments:[{id:"minecraft:sharpness",lvl:2s}]} 1
