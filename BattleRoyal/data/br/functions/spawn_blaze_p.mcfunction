execute in minecraft:the_nether as @e[type=piglin,tag=!n] if predicate br:blaze_random at @s run summon armor_stand ~ ~ ~ {Tags:["Blaze-p"],Invisible:1b, Invulnerable:1b}
execute as @e[tag=Blaze-p] run function br:random
